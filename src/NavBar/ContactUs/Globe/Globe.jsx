...
const Globe = () => {
  ...
  useEffect(() => {
    ...
    let camera = new THREE.PerspectiveCamera(45, aspect, 1, 2000);
    ...
    camera.position.setFromSphericalCoords(1, convertLat(India.lat), convertLon(India.lon)).setLength(cameraDistance(container.clientWidth));
  ...
  return (
    <div id="globeContainer" className="globe-container">
